...
class _OrderFilterScreenState extends State<OrderFilterScreen> {
  ...
  List<String> listOfStatus = ["All","Pending","Settled"];
                      ...
                      Expanded(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            icon: Icon(Icons.calendar_today,color: Palette.iconBackgroundColorPurple,),
                            labelText: "From Date",
                            floatingLabelStyle: TextStyle(
                              color: Palette.textColorLightPurple,
                            ),
                            border: InputBorder.none,
                            suffix: IconButton(onPressed: (){fromDate.text = "";}, icon: Icon(Icons.clear,size: 15,))
                          ),
                      ...
                      Expanded(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            border: InputBorder.none,
                            suffix: IconButton(onPressed: (){toDate.text = "";}, icon: Icon(Icons.clear,size: 15,))
                          ),
                          readOnly: true,
                          onTap: () async {
